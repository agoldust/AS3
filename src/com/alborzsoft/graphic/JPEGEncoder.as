package com.alborzsoft.graphic
{
	...
	/**<p>2 to 4 times Faster JPEG Encoding with Flash Player 10</p>
	 * 
	 * @see http://www.bytearray.org/?p=775
	 * @langversion 3.0
	 * @playerversion Flash 10, AIR 1.5
	 */
	public final class JPEGEncoder extends EventDispatcher
	{
		...
		/**
		 * Constructor for JPEGEncoder2 class 
		 *
		 ...
		 * @tiptext
		 */	
		public function encodeProgress(image:BitmapData, delay:uint=10):void
		{
			// Initialize bit writer
			byteout = new ByteArray();
			bytenew=0;
