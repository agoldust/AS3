package com.alborzsoft.components
{
	...
	public class CurvedText extends MovieClip
	{
		 ...
		 */
		public function draw(container:MovieClip):void {
			...
			if(_letterHolder && contains(_letterHolder)) removeChild(_letterHolder);
			
			
			_letterHolder = new MovieClip();
			container.addChild(_letterHolder);
