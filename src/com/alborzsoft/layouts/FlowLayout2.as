	...
	public class FlowLayout2 extends LayoutBase
	{
	    ...
	    override public function updateDisplayList(containerWidth:Number, containerHeight:Number):void
	    {
	        ...
	        for (var i:int = 0; i < count; i++)
	        {
				...
				if(x + elementWidth > parent.width)
				{
					// Start from the left side
					x = 0;
					...
					if(y + elementHeight > parent.height) 
					{
						parent.height = y + elementHeight;
						
						//trace(parent.id + ' Height Up to: ' + parent.height);
					}
				...
				if(y + elementHeight < parent.height) 
				{
					...
					//trace(parent.id + ' Height Down to: ' + parent.height);
				}
		...
		{
			return this.target.parent.parent.parent.parent as List;
		}
	}
}